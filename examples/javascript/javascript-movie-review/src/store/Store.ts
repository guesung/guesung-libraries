...
import type { LocalStorageMovieRateValueType } from "@/modules";
import type { MovieDetailResponse, MoviesResponse, MovieType } from "@/types";
...
export const movieDetailResponseStore = new Store<MovieDetailResponse | null>(
	null,
);
...
export const movieRateStore = persisted(
	"movieRate",
	new Store<LocalStorageMovieRateValueType>({}),
);
