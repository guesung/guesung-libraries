...
import type { StrictPropsWithChildren } from "@/types/strict";
			...
			{isOpen &&
				createPortal(
					<>
						...
						<S.ModalBackdrop
							onClick={isBackdropClose ? close : undefined}
...
function Close({
	children,
	...props
}: StrictPropsWithChildren & HTMLAttributes<HTMLButtonElement>) {
...
function CancelButton({
	children,
	...props
}: StrictPropsWithChildren<CancelButtonProps>) {
	const { close } = useContext(ModalContext);
